...
beautiful.init("/home/elchupa/.config/awesome/themes/darkblue/theme.lua")
...
mymainmenu = awful.menu({ items = { { "awesome", myawesomemenu, beautiful.awesome_icon },
				    { "dev", mydevwindow, beautiful.awesome_icon  },
...
-- {{{ Battery state
-- Initialize widget
vicious.register(mybattery, vicious.widgets.bat, "$1$2 ", 1, "BAT0" )

mytextclock = awful.widget.textclock({ align = "right" }, "%a %d %b %H:%M", 1 )

-- function to get the command output as a str
...
globalkeys = awful.util.table.join(
	...
	awful.key( {}, "#122", function() awful.util.spawn( "amixer set Master 5- unmute" ) end ),
	awful.key( {}, "#123", function() awful.util.spawn( "amixer set Master 5+ unmute" ) end )

	-- move client to different monitors
